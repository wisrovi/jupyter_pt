...
class State:
    ...
    def __init__(self, name:str=None, number:int=None, next_state:str=None, tabular:str=""):
        """
        ...
        @type tabular: str
        @param tabular: String containing the tabular of this state, used only for print in verbose mode.
        """
        if name:
            self.name = name
        else:
    ...
    def execute(self, **kwargs: dict) -> dict:
        """
        execute the current state according to passed parameters and return the next one.
        ...
        """
        This method must be implemented in the child class with the logic of the state.
        is called by the __call__ method.
