...
class Machine:
    ...
    def get_next_state(self):
        ...
        if next_state:
            ...
            if next_state in self.state: 
                ...
                print(f'{self.tabular}[{__main__.__file__}]: next state: {next_state}, does not exist!!!')
                return None
        return None
    ...
    def initialize(state: Union[list,dict]) -> dict:
        """
        It receives a list of States and converts it to a dictionary with the name and instantiated object of the class.
        
        @type state: list[State] or dict
        @param state: list or data dictionary.
        
        @rtype: dict
        @returns: dictionary with the name and instantiated object of the class.
        """
    ...
    def cicle(self, **kwargs:dict) -> dict:
        """
        It loops through each of the states, executes them, until the next one is None.
