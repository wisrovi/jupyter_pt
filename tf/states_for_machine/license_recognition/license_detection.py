...
class LicenceDetection(State):
    ...
    yolo = YoloPredictor(CONFIG.yolo_repo, CONFIG.yolo_model_license_detection, CONFIG.class_inference_license_detection)
    ...
    def execute(self, **kwargs: dict) -> dict:
        ...
        @param example: a example for input data in file "example_input_kwargs_license_detection.json"

        @rtype: dict
        @returns: dict with data processed, add licenses in frame if exist
        @return example: a example for output data in file "example_output_kwargs_license_detection.json"
        """    
